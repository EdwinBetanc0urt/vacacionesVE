...
class vacacion
{
	...
	/**
	 * Metodo getFechaFormato
	 * 
	 * @param string $pmFecha, fecha enviada para formatear
	 * @param string $pmFormatoE, formato de entrada en el cual se envio la fecha
	 * @param string $pmFormatoR, formato al cual estara la fecha de retorno
	 * @return $lsFecha, fecha formateada
	 */
...
/*
$objCalcula = new vacacion();
$resultado = $objCalcula->getFechaFinal("2018-04-01", "13");
var_dump($resultado);
*/
?>
